...
This example demonstrates that an opskarta v3 plan can be **valid and useful without a `schedule` block** — just structure, hierarchy, dependencies, and effort estimates.

## What It Demonstrates

### Key v3 Concept: Overlay Schedule

In v3, calendar planning is an **optional layer** applied on top of work structure. A plan without `schedule`:
