...
This example demonstrates a key capability of opskarta v3: **some nodes are scheduled for the current sprint, while others remain in the backlog without calendar dates**.

## What It Demonstrates

### Key Idea: Opt-in Scheduling

In v3, only nodes explicitly listed in `schedule.nodes` participate in calendar planning. Other nodes:
