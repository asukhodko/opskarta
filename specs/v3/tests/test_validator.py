...
from specs.v3.tools.validator import (
...
class TestValidateVersion(unittest.TestCase):
    ...
    def test_version_1_is_invalid(self):
        """Plan with version 1 is invalid for v3 tools."""
        ...
        self.assertIn("migrate", result.errors[0].message)
    ...
    def test_default_version_is_valid(self):
        """Plan with default version (3) is valid."""
        plan = MergedPlan()  # version defaults to 3
    ...
    def test_version_4_is_invalid(self):
        """Plan with version 4 is invalid for v3 tools."""
        plan = MergedPlan(version=4)
        
        result = validate(plan)
        
        self.assertFalse(result.is_valid)
        self.assertIn("4", result.errors[0].actual)
...
class TestValidateScheduleReferences(unittest.TestCase):
    ...
    def test_valid_calendar_reference(self):
        ...
        from specs.v3.tools.models import Schedule, ScheduleNode, Calendar
    ...
    def test_valid_default_calendar_reference(self):
        ...
        from specs.v3.tools.models import Schedule, Calendar
    ...
    def test_empty_schedule_is_valid(self):
        ...
        from specs.v3.tools.models import Schedule
...
class TestValidateViews(unittest.TestCase):
    ...
    def test_valid_view_with_where_kind(self):
        ...
        from specs.v3.tools.models import View, ViewFilter
...
class TestValidateViewsIntegration(unittest.TestCase):
    ...
    def test_valid_complex_plan_with_views(self):
        ...
        from specs.v3.tools.models import View, ViewFilter, Schedule, ScheduleNode
