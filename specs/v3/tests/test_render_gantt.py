...
from specs.v3.tools.render.gantt import (
    render_gantt,
    _get_descendants,
    _sanitize_task_id,
)
...
class TestRenderGanttBasic(unittest.TestCase):
    ...
    def test_single_task(self):
        ...
        self.assertIn("Task 1  :task1,    2024-03-11, 3d", result)
...
class TestRenderGanttUsesScheduleCalendar(unittest.TestCase):
    ...
    def test_dates_respect_calendar_weekends(self):
        ...
        # Mermaid gets the duration plus the calendar exclusions; the
        # second task still proves the dependency start was computed.
        self.assertIn("2024-03-15", result)  # task1 start
        self.assertIn("Task 1  :task1,    2024-03-15, 3d", result)
    ...
    def test_dates_respect_calendar_holidays(self):
        ...
        # Mermaid gets the duration plus the calendar exclusions.
        self.assertIn("excludes weekends 2024-03-12", result)
